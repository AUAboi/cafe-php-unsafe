...
<body class="bg-orange-300 tracking-wider">
  <header>
    <p class="text-center font-bold text-orange-700 text-3xl mt-5 md:text-5xl md:mt-10">Cafe Payala Admin Panel</p>
  </header>
    ...
    <div class="field-group">
        <div class="my-2">
            <input type="checkbox" name="remember" id="remember"
                ...
                <?php } ?> /> <label for="remember-me" class="text-gray-600">Remember me</label>
        </div>
    </div>
    <div class="field-group">
        <div class="my-2">
